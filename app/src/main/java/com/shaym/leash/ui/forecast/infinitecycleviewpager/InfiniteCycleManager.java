package com.shaym.leash.ui.forecast.infinitecycleviewpager;
...
class InfiniteCycleManager implements OnNotifyDataSetChangedListener {
    ...
    // When viewpager_item count equals to 3 we need stack count for know is viewpager_item on position -2 or 2 is placed
    ...
    InfiniteCycleManager(
        ...
        OnPageChangeListener mInfinityCyclePageChangeListener = new ViewPager.SimpleOnPageChangeListener() {
            @Override
    ...
    void setMinPageScaleOffset(final float minPageScaleOffset) {
    ...
    void setCenterPageScaleOffset(final float centerPageScaleOffset) {
    ...
    void setMinPageScale(final float minPageScale) {
    ...
    void setMaxPageScale(final float maxPageScale) {
    ...
    void setMediumScaled(final boolean mediumScaled) {
    ...
    void setScrollDuration(final int scrollDuration) {
    ...
    void setOnInfiniteCyclePageTransformListener(
    ...
    InfiniteCyclePageTransformer getInfinityCyclePageTransformer() {
        return new InfiniteCyclePageTransformer();
    }

    InfiniteCyclePagerAdapter getInfiniteCyclePagerAdapter() {
    ...
    // Set current viewpager_item where you put original adapter position and this method calculate nearest
    // position to scroll from center if at first initial position or nearest position of old position
    int setCurrentItem(final int item) {
        mIsInitialItem = true;
    ...
    void postInvalidateTransformer() {
        mViewPageable.post(() -> {
    ...
    // Start auto scroll
    void startAutoScroll(final boolean isAutoScrollPositive) {
